...
class RequestHandler(http.server.SimpleHTTPRequestHandler):
  ...
  def send_ponctualite(self):
    ...
    c.execute("SELECT Date,`Taux de régularité` FROM 'regularite-mensuelle-ter' WHERE Région='Rhône Alpes' ORDER BY Date")
    r = c.fetchall()
    ...
    plt.savefig('TC3/TD2/client/{}'.format(fichier))
